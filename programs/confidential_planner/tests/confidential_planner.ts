...
import { ConfidentialPlanner } from "../target/types/confidential_planner";
...
describe("ConfidentialPlanner", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .ConfidentialPlanner as Program<ConfidentialPlanner>;
  ...
  async function initAddTogetherCompDef(
    program: Program<ConfidentialPlanner>,
